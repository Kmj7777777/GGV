...
public class MemberServiceImpl implements MemberService {
	...
	@Override
	public int phoneAuth(String phone) {
		return new Phone().send(phone);
	}
	...
	public void emailAuthForJoin(TempMemberDTO tempMemberDTO) {
		...
		new SMTP().send_mail(tempMemberDTO.getEmail(), tempMemberDTO.getId(), email_auth_key);
	}
	...
	public int emailAuth(String email) {
		return new SMTP().send_mail(email);
	}
